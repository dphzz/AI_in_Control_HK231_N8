...
dataframe=pd.read_excel('Billboard.xlsx')
X0=dataframe.values[:,3]
X1=dataframe.values[:,6]
...
ax0.set_xlabel('Days')
ax0.set_ylabel('Audience')
ax0.set_zlabel('Position')
plt.title('Raw Data')
...
ax_result.set_xlabel('Days')
ax_result.set_ylabel('Audience')
ax_result.set_zlabel('Position')
